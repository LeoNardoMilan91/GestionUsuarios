...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('titulo'); ?> Gestión <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    <form name="sd" method="POST" action="<?php echo e(route('usuarios.update', $usuario)); ?>" class=" p-4 bg-secondary text-light">
        <?php echo csrf_field(); ?>
        <?php echo method_field("PUT"); ?>
        <?php app(\ProtoneMedia\LaravelFormComponents\FormDataBinder::class)->bind($usuario); ?>
        <?php if (isset($component)) { $__componentOriginalc6dc29918f642c0cf8bf87f6c59d196df1a6e1b4 = $component; } ?>
<?php $component = $__env->getContainer()->make(ProtoneMedia\LaravelFormComponents\Components\FormInput::class, ['name' => 'nomusu','label' => 'Nombre Usuario']); ?>
...
<?php $component = $__env->getContainer()->make(ProtoneMedia\LaravelFormComponents\Components\FormSelect::class, ['name' => 'perfil_id','options' => $misPerfils,'label' => 'Asigna un perfil']); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\srv\laravel\GestionUsuarios\GestionUsuarios\resources\views/usuarios/edit.blade.php ENDPATH**/ ?>