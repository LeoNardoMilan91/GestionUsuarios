...
<?php endif; ?>
    <form name="sd" method="POST" action="<?php echo e(route('usuarios.store')); ?>" class=" p-4 bg-secondary text-light">
        <?php echo csrf_field(); ?>
        <?php if (isset($component)) { $__componentOriginalc6dc29918f642c0cf8bf87f6c59d196df1a6e1b4 = $component; } ?>
<?php $component = $__env->getContainer()->make(ProtoneMedia\LaravelFormComponents\Components\FormInput::class, ['name' => 'nombre','label' => 'Nombre Usuario']); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\srv\laravel\GestionUsuarios\GestionUsuarios\resources\views/usuarios/create.blade.php ENDPATH**/ ?>