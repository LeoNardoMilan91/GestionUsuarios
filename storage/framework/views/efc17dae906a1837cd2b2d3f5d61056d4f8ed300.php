...
<?php endif; ?>
    <form name="sd" method="POST" action="<?php echo e(route('perfiles.update', $perfile)); ?>" class=" p-4 bg-secondary text-light">
        <?php echo csrf_field(); ?>
        <?php echo method_field("PUT"); ?>
        <?php app(\ProtoneMedia\LaravelFormComponents\FormDataBinder::class)->bind($perfile); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\srv\laravel\GestionUsuarios\GestionUsuarios\resources\views/perfiles/edit.blade.php ENDPATH**/ ?>